...
#define CKS_FUNC_ATTR_INTRINSICS_ARM_NEON
#define CKS_FUNC_ATTR_INTRINSICS_ARM_SHA256
    ...
    #undef CKS_FUNC_ATTR_INTRINSICS_ARM_NEON
    #define CKS_FUNC_ATTR_INTRINSICS_ARM_NEON __attribute__((target("+simd")))

    #undef CKS_FUNC_ATTR_INTRINSICS_ARM_SHA256
    #define CKS_FUNC_ATTR_INTRINSICS_ARM_SHA256 __attribute__((target("+simd,+crypto")))
#endif
